...
# this code just tries to solve the puzzle using basic techniques
...
def trim(solution):
    ...
    for index in indices:
        ...
        if not checkValid(trimmed):
            ...
            counter += 1
        if counter == 50:  # delete this for harder sudoku
            break
    return trimmed
...
def home():
    ...
    headLbl.pack()
    main = "Click the button to create\na new randomized sudoku."
